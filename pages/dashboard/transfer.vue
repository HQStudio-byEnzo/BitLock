  ...
  <div class="section-shell max-w-6xl py-10 md:py-16 space-y-6">
    ...
    <div class="grid gap-5 lg:grid-cols-2">
      <section class="glass-panel p-5 md:p-6 space-y-4">
        ...
        <div class="flex gap-2"><input v-model="transferCode" class="input-field font-mono" :aria-label="t('transfer.code')" :placeholder="t('transfer.code')" /><button class="btn-secondary" :aria-label="t('transfer.newCode')" @click="newCode"><Icon name="lucide:dices" class="w-4 h-4" /></button></div>
      ...
      <section class="glass-panel p-5 md:p-6 space-y-4">
        ...
        <button type="button" class="btn-secondary w-full" @click="fileInput?.click()"><Icon name="lucide:file-up" class="w-4 h-4" />{{ t('transfer.chooseFile') }}</button>
